...
import com.commoditylive.client.ui.CommodityChartPanel;
import com.commoditylive.client.ui.CommodityTableManager;
...
public class CommodityLiveGUI extends JFrame {
    ...
    private CommodityLiveAdminUI adminUI;
    ...
    private void initializeGUI() {
        setTitle("CommodityLive - Executive Dashboard");
        setSize(1000, 700);
    ...
    private JPanel createHeader() {
        ...
        JLabel title = new JLabel("CommodityLive");
    ...
    private CommodityLiveAdminUI getAdminUI() {
        if (adminUI == null) adminUI = new CommodityLiveAdminUI(this);
        return adminUI;
    }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new CommodityLiveGUI().setVisible(true));
    }
}
