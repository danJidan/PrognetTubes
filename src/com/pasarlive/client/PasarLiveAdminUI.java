...
class PasarLiveAdminUI {
    ...
    private void handleDeleteCommodity() {
        ...
        if(JOptionPane.showConfirmDialog(dashboardDialog, "Hapus permanen?") == JOptionPane.YES_OPTION) {
    ...
    void refreshReportTable() {
        ...
        // Note: Karena response asynchronus, tabel akan update setelah message response diterima di PasarLiveGUI
        // Untuk sekarang, kita ambil snapshot lokal dulu kalau ada
        // reportTableManager.refresh(parent.getReportsSnapshot());
    }
    
    // Dipanggil dari PasarLiveGUI saat data laporan baru datang dari server
    ...
    // Jangan lupa update PasarLiveGUI handleMessage untuk memanggil updateReportTableData
